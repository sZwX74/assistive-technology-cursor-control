...
while True:
    ...
    if landmark_points:
        ...
        # eye_anchor = [263, 463, 374, 386, 398, 384, 385, ]
        eye_anchor = [463, 398, 384, 385, 386, 387, 388, 466, 263 ] + [249, 390, 373, 374, 380, 381, 382, 362]
        ...
        # Using OpenCV's fitEllipse to get ellipse parameters
        ellipse = cv2.fitEllipse(points_np)

        # Extracting the center of the ellipse
        eye_anchor_x, eye_anchor_y = map(int, ellipse[0])
