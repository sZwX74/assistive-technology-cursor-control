...
def load_mnist_data(train_noise = False, validation_noise = False):
    ...
    validation_data = dsets.MNIST(root='./data', train=False, download=True, transform=validation_transform)
...
load_mnist_data(validation_noise = True)